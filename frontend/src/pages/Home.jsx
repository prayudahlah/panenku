...
const Home = () => {
    return (
        <>
                ...
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-full max-w-4xl px-4 z-20">
                    <div className="bg-white rounded-xl shadow-lg p-2">
                        <div className="flex">
                            ...
                            <button className="px-6 py-2 bg-primary-green text-white font-medium rounded-r-md hover:bg-primary-green-800 transition">
                                Cari
                            </button>
                        </div>
                    </div>
            ...
            {/* Spacer agar konten di bawah tidak ketutup card */}
            <div className="h-16" />
        </>
    );
};
